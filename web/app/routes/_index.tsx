					...
					<header className="flex flex-col items-center gap-5">
						<div className="space-y-10">
							<div className="space-y-3">
								<h1 className="animate-bounce bg-gradient-to-r from-[#f18f01] to-[#f18301] bg-clip-text text-center text-5xl text-6xl font-bold font-extrabold text-[#f18f01] text-transparent [animation-iteration-count:1.49] lg:text-9xl">
									MatchPoint
								</h1>
			...
			<div className="flex flex-row items-center justify-center bg-[#f4f4f4] py-20 text-center">
				...
				<div className="flex w-1/2 flex-col items-center justify-center px-10 text-center">
					...
					<div className="mt-10 flex flex-wrap gap-8">
						<button className="w-full rounded-lg bg-white p-6 text-left shadow-lg hover:bg-[#f18f01]/50">
