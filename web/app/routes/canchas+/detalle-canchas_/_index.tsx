	...
	return (
		<Sheet>
			<SheetTrigger asChild>
				<Button
					className="transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-[#f18f01]"
					variant="outline"
				>
	...
	return (
		<div className="h-full bg-[#f2f4f3]">
			<div className="flex h-full flex-row items-center justify-center space-x-12">
				<Card className="w-full max-w-lg p-10 shadow-lg">
					<CardHeader className="space-y-5">
						...
						<div className="flex flex-row">
							<img src="../location-logo.png" className="h-[35px] w-[35px]" />
				...
				<div className="flex h-screen w-[600px] flex-col items-center justify-center space-y-5">
...
export default function FieldDetailInstance() {
