    ...
    Tables: {
      fields: {
        Row: {
          ...
          adminedBy: string[] | null // Added adminedBy property
        }
        Insert: {
          avatar_url?: string | null
          city: string
      ...
      reservations: {
        Row: {
          ...
          bookers_count: number | null; // Added bookers_count property
          pending_bookers_ids: string[] | null; // Added pending_bookers_ids property
        }
        Insert: {
          date_time: string
          field_id: string
      ...
      inscriptions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inscriptions_teamId_teams_id_fk"
            columns: ["teamId"]
            isOneToOne: false
