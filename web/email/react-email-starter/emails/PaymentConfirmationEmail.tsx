import { Body, Container, Head, Heading, Html, Img, Section, Tailwind, Text, Link } from "@react-email/components";
				...
				<Body className="bg-white px-2 font-sans">
					...
					<Container className="mx-auto my-[20px] max-w-[465px] rounded border border-solid border-[#eaeaea]">
						...
						<Section className="bg-[#f2f4f3] p-4 text-[#223332]">
							...
							<Text className="text-[15px]">¿Sabías que ahora podes dividir el pago con tus amigos?</Text>
							<Text className="text-[15px]">¿Qué esperás? Reservá tu cancha ahora.</Text>
							{/* <Section>
							...
							<Link href="https://matchpointapp.com.ar">matchpointapp.com.ar</Link>
						</Section>
					</Container>
				</Body>
			</Tailwind>
