...
export const queries = {
  ...
  getInscriptionsByUser: (supabase: SupabaseClient<Database>, userId: string) =>
    supabase
      .from("teams")
...
export function useDeleteInscription(supabase: SupabaseClient<Database>) {
  return useDeleteMutation(supabase.from("inscriptions"), ["id"], "*", {
    onError: (error) => {
